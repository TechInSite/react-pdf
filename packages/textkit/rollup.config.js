...
const serverProdConfig = Object.assign({}, serverConfig, {
  output: [
    getESM({ file: 'lib/textkit.es.min.js' }),
    getCJS({ file: 'lib/textkit.cjs.min.js' }),
  ],
...
const browserProdConfig = Object.assign({}, browserConfig, {
  output: [
    getESM({ file: 'lib/textkit.browser.es.min.js' }),
    getCJS({ file: 'lib/textkit.browser.cjs.min.js' }),
  ],
